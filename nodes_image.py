...
class AdjustImageNode(PreviewImage):
    ...
    OUTPUT_NODE = False # Override inherited value from PreviewImage.
    ...
    def adjust_image(self,
        ...
        if saturation != 1.0:
            ...
            lum = 0.299 * new_image[0] + 0.587 * new_image[
                1] + 0.114 * new_image[2]  # H x W
        ...
        res = super().save_images(new_image,
                                  filename_prefix="AdjustImage-",
                                  prompt=prompt,
                                  extra_pnginfo=extra_pnginfo)
