...
from .mega_prompt import MegaPrompt, ContextBreak, FaceContextBreak, PrepareCheckpoint, PrepareLoRA, TagStacker, TagTweaker
...
nodes = [
    ...
    DownloadCivitaiModel, MegaPrompt, ContextBreak, FaceContextBreak, PrepareCheckpoint, PrepareLoRA, TagStacker, TagTweaker, AdjustImageNode,
