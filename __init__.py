...
nodes = [RegexNode, ExtractTagFromString, AutoExtractTags, ChainReplace, StableRandomChoiceNode, PromptTidy, DownloadCivitaiModel, MegaPrompt, ContextBreak, FaceContextBreak, PrepareCheckpoint, TagStacker]
